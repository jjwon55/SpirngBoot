 ...
 * [PUT]       - /posts/update       :수정 처리 (JSON)

 * [POST]    - /posts/delete/{no}  :삭제처리 (FORM)
 * [DELETE]    - /posts/{no}         :삭제처리 (JSON)
 */
...
public class PostController {
    ...
    // ⭐ MVC
    // Controller ➡ Service (데이터요청)
    // Controler ⬅ Service (데이터 전달)
    ...
    */
    ...
    public String list(Model model)  throws Exception {
        ...
        // 뷰지정
        return "posts/list";       //resources/template/posts/list.html
    }
    ...
    public ResponseEntity<?> updatePutJON(@RequestBody Posts post) throws Exception {
        // 데이터 요청
        boolean result = postService.update(post);
        // 리다이렉트
        // ⭕ 데이터 처리 성공
